                  ...
                  <div className="flex items-start justify-between gap-4">
                    <div className="flex min-w-0 items-start gap-4">
                      ...
                      <div className="min-w-0">
                        <CardTitle className="text-xl font-extrabold text-[#271f1b]">Job posting details</CardTitle>
                        <p className="mt-1 text-sm font-semibold leading-6 text-[#8a7c75]">Edit anything you want the interview to use.</p>
                      </div>
                    </div>
